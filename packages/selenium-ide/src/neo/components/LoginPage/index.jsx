    ...
    render() {
      return (
        <div className='supahbot-login-form'>
          ...
          <br/>
          <input style={{ fontSize: 20, borderRadius: 10, padding: 5, paddingLeft: 10 }} placeholder='hunter2' name='password' value={this.state.password} type='password' onChange={(event) => this.changeField(event)} />
          <br/>
